...
import Image from '~/assets/images/icons/microscop.png?jsx';

export const FactoryButton = component$(() => {
    const tabName = 'factory';
    ...
    return (
        <>
            ...
            >
                <Image class="size-18" />
                <span class="text-md font-bold">Labs</span>
            </button>   
        </>
    );
});